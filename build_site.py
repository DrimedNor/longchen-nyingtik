...
/* 悬浮搜索/AI问答按钮 */
.fab-search{position:fixed;top:12px;right:12px;z-index:100;width:42px;height:42px;border-radius:50%;
  background:var(--accent);color:#fff;border:none;cursor:pointer;font-size:1.1em;
  box-shadow:0 2px 10px rgba(0,0,0,.25);display:flex;align-items:center;justify-content:center;
  transition:transform .2s,box-shadow .2s}
.fab-search:hover{transform:scale(1.08);box-shadow:0 4px 15px rgba(0,0,0,.3)}
...
<div class="topbar">
  ...
  <button class="fab-search" id="fabSearch" title="搜索 / AI 问答">🔍</button>
</div>
...
// ---- 悬浮搜索/AI问答面板 ----
var fabBtn = document.getElementById('fabSearch');
if (fabBtn) fabBtn.addEventListener('click', function(){ openSearchPanel('search'); });
